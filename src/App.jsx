...
function App() {
  ...
  return (
    <>
      <body className=" bg-slate-950 relative flex flex-col items-center">
        <Navbar />
        <div className="w-full h-12"></div>
        <div className="main h-full w-3/4 mx-auto flex flex-col gap-40">
          <div className="header flex flex-col gap-10">

            <div className="header text-8xl w-2/3 font-extrabold text-yellow-100 uppercase leading-relaxed">Reveal the truth behind AI hype:</div>
            <div className="header text-5xl text-white font-semibold uppercase">Cutting through noise, we explain how AI transforms work and life</div>
          </div>
          <div className='flex justify-between'>
          <div className="w-2/5 object-contain"><img src={ai} alt="" /></div>
          <div className='w-2/5 text-6xl text-white leading-relaxed text-justify'>AI <br /> Opportunity for the visionaries. Disappointment for the rest</div>
          </div>
          ...
          <div className="flex justify-between ">
            <div className="w-2/5 text-6xl text-white">Embrace a world of endless possibilities as we harness the power of innovation.</div>
